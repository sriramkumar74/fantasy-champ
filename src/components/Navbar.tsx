...
import { Trophy, Users, Shield, BarChart3, Bell, Menu, X, ArrowLeftRight, Calendar, Plus } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import NotificationsPanel from "@/components/NotificationsPanel";

const navItems = [
  { label: "Dashboard", path: "/dashboard", icon: Trophy },
  { label: "Leagues", path: "/leagues/create", icon: Users },
  { label: "Teams", path: "/teams", icon: Shield },
  { label: "Draft", path: "/draft", icon: BarChart3 },
  { label: "Trades", path: "/trades", icon: ArrowLeftRight },
  { label: "Transfers", path: "/weekly-modification", icon: Calendar },
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="relative p-2 rounded-md text-muted-foreground hover:text-foreground fc-transition"
              >
                <Bell size={18} />
